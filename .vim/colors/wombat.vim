...
" General colors
hi Cursor 		guifg=NONE    guibg=#656565 gui=none   ctermfg=NONE ctermbg=white  cterm=none
...
hi Function 	guifg=#cae682 gui=none   ctermfg=187       cterm=none
hi Type 		guifg=#cae682 gui=none   ctermfg=186       cterm=none         
hi Statement 	guifg=#8ac6f2 gui=none   ctermfg=lightblue cterm=none
hi Keyword		guifg=#8ac6f2 gui=none   ctermfg=lightblue       cterm=none         
